            ...
            <div className="col-lg-6 col-12 d-lg-block d-none">
              <div className="d-flex justify-content-lg-end justify-content-center me-lg-5">
                <div className="position-relative" data-aos="zoom-in">
                  <Image src="/img/Header-1.png" alt="Header 1" width={490} height={484} />
                  <div className="card left-card position-absolute border-0">
                    <div className="d-flex align-items-center mb-16 gap-3">
                      <Image src="/img/Header-2.png" alt="Header 2" width={40} height={40} className="rounded-pill" />
                      <div>
                        <p className="text-sm fw-medium color-palette-1 m-0">Olivia Rodrigo</p>
                  ...
                  <div className="card right-card position-absolute border-0">
                    <div className="position-relative d-flex flex-row justify-content-center mb-24">
                      ...
                      <Image src="/img/Header-3.png" width={80} height={80} className="rounded-pill" alt="" />
