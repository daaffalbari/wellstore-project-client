              ...
              <section className="checkout mx-auto">
                ...
                <div className="purchase pt-30">
                  ...
                  <p className="text-lg color-palette-1 mb-20">
                    Your Game ID <span className="purchase-details">daaffalbari</span>
                  </p>
                  <p className="text-lg color-palette-1 mb-20">
                ...
                <div className="payment pt-10 pb-10">
                  ...
                  <p className="text-lg color-palette-1 mb-20">
                    Your Account Name <span className="purchase-details">Daffa Albari</span>
                  </p>
                  <p className="text-lg color-palette-1 mb-20">
                  ...
                  <p className="text-lg color-palette-1 mb-20">
                    Bank Account Name <span className="payment-details">Mr Daffa Albari</span>
                  </p>
                  <p className="text-lg color-palette-1 mb-20">
