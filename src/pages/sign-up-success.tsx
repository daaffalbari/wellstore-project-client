...
import SignUpSuccesIllustration from '../../components/organisms/SignUpForm/SignUpSucces';

export default function SignUpSuccess() {
  return (
    <section className="sign-up-success mx-auto pt-md-179 pb-md-179 pt-150 pb-100">
      <div className="container-fluid">
        <SignUpSuccesIllustration />
        ...
        <div className="button-group d-flex flex-column mx-auto">
          <a className="btn btn-top-up fw-medium text-lg text-white rounded-pill" href="../index.html" role="button">
            Top Up
          </a>
        </div>
      </div>
